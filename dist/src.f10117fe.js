...
function () {
  ...
  Eventing.prototype.fetch = function () {
    var _this = this;

    axios.get("http://localhost:3000/users/" + this.get('id')).then(function (response) {
      _this.set(response.data);
    });
  };

  Eventing.prototype.save = function () {
    var id = this.get('id');
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/WIN 10/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
var User_1 = require("./models/User"); // axios.post('http://localhost:3000/users', {
//     name: 'myname',
//     age: 20
// }); 
...
},{}]},{},["C:/Users/WIN 10/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
